...
export const FirstJobDescripition = () => {
  ...
  return (
    <Box>
      <Button onClick={onOpen} marginLeft="0.5rem" w="8rem" colorScheme='orange' color="white">
        Projeto Social
      </Button>

      <Modal isCentered onClose={onClose} size={isLargerThan456 ? "md" : "xs"} isOpen={isOpen}>
        <ModalOverlay />
